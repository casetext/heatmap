...
/**
 * Add enter, leave, move, and click listeners to the containers.
 *
 * @private
 */
...
Heatmap.prototype._bindEvents = function() {
  ...
  .on('mouseenter', function() {
    self._onSourceMouseenter(d3.mouse(this));
  })
  .on('mouseleave', function() {
    self._onSourceMouseleave(d3.mouse(this));
  })
  ...
  this.target
  .on('mouseenter', function() {
    self._onTargetMouseenter(d3.mouse(this));
  })
  .on('mouseleave', function() {
    self._onTargetMouseleave(d3.mouse(this));
  })
  .on('mousemove', function() {
...
/**
 * When the cursor enters the source container.
 *
 * @param {Array} position: The cursor X and Y coordinates.
 * @private
 */

Heatmap.prototype._onSourceMouseenter = function(position) {
  console.log('source mouseenter', position);
};


/**
 * When the cursor leaves the source container.
 *
 * @param {Array} position: The cursor X and Y coordinates.
 * @private
 */

Heatmap.prototype._onSourceMouseleave = function(position) {
  console.log('source mouseleave', position);
};
...
/**
 * When the cursor enters the target container.
 *
 * @param {Array} position: The cursor X and Y coordinates.
 * @private
 */

Heatmap.prototype._onTargetMouseenter = function(position) {
  console.log('target mouseenter', position);
};


/**
 * When the cursor leaves the target container.
 *
 * @param {Array} position: The cursor X and Y coordinates.
 * @private
 */

Heatmap.prototype._onTargetMouseleave = function(position) {
  console.log('target mouseleave', position);
};
