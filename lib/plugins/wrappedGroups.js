...
var WrappedGroups = function(heatmap) {
...
WrappedGroups.prototype.addGroup = function(name, selector) {
...
WrappedGroups.prototype.updateSize = function() {
...
WrappedGroups.prototype._getGroupNames = function() {
...
WrappedGroups.prototype._selectGroup = function(name) {
  ...
  this.heatmap.$source.find(group.selector).each(function(i, el) {
    ...
    group.elements.push(new Avatar(source, target));
...
WrappedGroups.prototype._renderGroup = function(name) {
  ...
  _.each(group.elements, function(avatar) {

    var offset = avatar.source.offset();
    ...
    var w = avatar.source.outerWidth()  * ratio;
    var h = avatar.source.outerHeight() * ratio;
